...
/**
 * Servlet implementation class SelectChangeSkeptServlet
 */
@WebServlet("/SelectChangeSkeptServlet")
public class SelectChangeSkeptServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectChangeSkeptServlet() {
        super();
