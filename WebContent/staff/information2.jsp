...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="com.manage.dao.domain.Skemp"%>
     <%
...
<body>
<div id="man_zone">
<form id="form1" name="form1" method="post" action="leavingse.jsp">
...
<%Skemp sk=(Skemp)request.getAttribute("skemp");
		if(sk==null)
		{
		%>
