...
function yanzheng(){  
if(document.form1.lztime.value =='')  { alert("离职时间不能为空");   
	        return false;} 
if(document.form1.lztype.value =='0')  { alert("请输入离职类型");   
	        return false;} 
if(document.form1.lzgoto.value =='')  { alert("离职去向不能为空");   
	        return false;}
			var vvv =confirm("您确定要离职");
...
<div id="man_zone">
<form id="form1" name="form1" method="post" action="<%=basePath %>LeaveInfoServlet?empno=<%=empno %>&jobid=<%=jobid %>" onsubmit="return yanzheng()">
  <table width="901" height="190" border="1" bordercolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="183" bgcolor="#FFFFFF"><label>
      <input name="lztime" type="text" id="starttime2" onclick="setday(this)" />
      </label></td>
      <td width="579" bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    <tr>
