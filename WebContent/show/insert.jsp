...
<% Department department=(Department)request.getAttribute("departments"); %>
<body>
<div id="man_zone">
<form name="fom" id="fom" method="post" action="<%=basePath %>DepartmentServlet?service=add"  onsubmit="return link1();">
              ...
              <tr>
			    ...
			    <%--<td width="10%"><div align="center">上级部门</div></td> --%>
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td><div align="center">
                      <label>
                      <input type="text" name="tele" size="12" />
                      </label>
                    </div></td>
                    <td><div align="center">
                      <label>
                      <input name="fax"  type="text" size="12" />
                      </label>
                    </div></td>
                    <td><div align="center">
                      <label>
