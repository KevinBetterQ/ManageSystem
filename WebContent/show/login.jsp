...
function yanzheng(){
var xm=document.form1.yonghuming.value;
if(xm==''){                                                                                                                            
alert("请填写用户名");
return false;  }
          ...
          <tr>
            <td height="190"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<form name="form1" method="post" onSubmit=" return yanzheng();"  action="<%=basePath %>ManagerServlet?service=login" >
                  <table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
					  ...
					  <input type="text" name="id" id="textfield" style="width:164px; height:32px; line-height:34px; background:url(images/inputbg.gif) repeat-x; border:solid 1px #d1d1d1; font-size:9pt; font-family:Verdana, Geneva, sans-serif;">
					  </td>
                    </tr>
                    <tr>
