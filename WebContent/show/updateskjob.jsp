...
<% Skjob skjob=(Skjob)request.getAttribute("skjob"); %>
<body>
<div id="man_zone">
<form name="fom" id="fom" onsubmit="return link1();"
action="<%=basePath %>SkjobServlet?service=update" method="post">>
        ...
        <tr>
          <td height="62" >
		   ...
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			  <td width="21"></td>
			  <td width="538"><strong>修改岗位信息</strong></td>
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
				...
				<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
				 <tr class="CTitle" >
                    	<td height="22" colspan="9" align="center" style="font-size:16px"> 修改岗位信息 </td>
                  </tr>
                  <tr bgcolor="#EEEEEE">
				    <td width="13%" height="30"><div align="center">岗位编号<span class="STYLE1">*</span></div></td>
                    <td width="17%"><div align="center">岗位名称<span class="STYLE1">*</span></div></td>
					<td width="14%"><div align="center">类型</div></td>
                    <td width="18%"><div align="center">岗位编制</div></td>
					<td width="18%"><div align="center">隶属部门</div></td>
				...
				<%--<td width="13%"><div align="center">成立日期</div></td>--%>
                  ...
                  <tr bgcolor="#FFFFFF">
				    <td height="20" ><div align="center">
                      <label>
                      <input name="id" value="<%=skjob.getId() %>"type="text" size="10" />
                      </label>
                    </div></td>
                    <td ><div align="center">
                      <label>
                      <input name="name" value="<%=skjob.getName() %>" type="text" size="12" />
                      </label>
                    </div></td>
					<td>
					  <div align="center">
					    <label>
					    <input name="type" value="<%=skjob.getType() %>" type="text" size="12" />
					    </label>
					</div></td>
                    <td><div align="center">
                      <label>
                      <input type="text" name="limit" value="<%=skjob.getLimit() %>" size="12" />
                      </label>
                    </div></td>
                    <td><div align="center">
                      <label>
                      <input name="deptno" value="<%=skjob.getDeptno() %>" type="text" size="12" />
                      </label>
                    </div></td>
                   <%-- <td><div align="center">
                      <label>
