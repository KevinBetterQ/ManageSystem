<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.manage.dao.domain.Manager"%>
     <%
...
<body>
<div id="man_zone">
  <form action="<%=basePath %>ManagerServlet?service=update"  onsubmit="return yanzheng();" method="post"  name="form1" id="form1"  >
    <div class="MainDiv">
        ...
        <tr>
          <td class="CPanel"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
              ...
              <tr bgcolor="#EEEEEE">
                ...
                <td width="111"><div align="center">主管领导</div></td>
                <td width="147"><div align="center">管理员ID</div></td>
               ...
               <% Manager manager=(Manager)request.getAttribute("manager"); %>
                <td height="40" align="center"><div align="center">
                    <label>
                    <input  type="text" name="name" size="12" value="<%=manager.getName()   %>"/>
                    </label>
                </div></td>
                <td><div align="center">
                  <label>
                  <input name="pass" type="text"  size="10" value="<%=manager.getPass()   %>"/>
                  </label>
                </div>             </td>
                <td><div align="center">
                    <label>
                    <input name="pass1" type="text" value="<%=manager.getPass()   %>" size="10" />
                    </label>
                </div></td>
                <td><div align="center">
                    <label>
                    <input name="explanation1" type="text" value="<%=manager.getExplanation1()%>" size="10" />
                    </label>
                </div></td>
                <td><div align="center">
                    <label>
                    <input name="explanation2" type="text" value="<%=manager.getExplanation2()%>" size="10" />
                    </label>
                </div></td>
                <td><div align="center">
                    <label>
                    <input name="explanation3" type="text" value="<%=manager.getExplanation3()%>" size="10" />
                    </label>
                </div></td>
                <td><div align="center">
                    <label>
                    <input name="id" type="text" value="<%=manager.getId()%>" size="16" />
                    </label>
                </div></td>
