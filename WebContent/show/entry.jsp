...
<body>
<div id="man_zone">
  <%-- <form action="<%=basePath %>EntryServlet" onsubmit="return link();" method="post" enctype="multipart/form-data" name="fom" id="fom" target="manFrame" > --%>
  <form action="<%=basePath %>EntryServlet"  onsubmit="return link();" method="post" name="fom" id="fom" target="manFrame"  >
    <div class="MainDiv">
        ...
        <tr>
          <td class="CPanel"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td width="10%" class="newfont03">员工编号<span class="STYLE4">*</span></td>
                <td width="10%" class="newfont03"><label>
                  <input name="userid" type="text" size="10" />
                </label></td>
                <td width="6%" class="newfont03">姓名<span class="STYLE4">*</span></td>
                <td width="10%" class="newfont03"><label>
                ...
                <td width="6%" class="newfont03"><select name="national">
                ...
                <td width="8%"><input name="bthday" type="text"onclick="setday(this)" size="10" /></td>
                <td width="6%">身份证号<span class="STYLE4">*</span></td>
                <td width="12%"><input name="id" type="text" size="20" /></td>
              </tr>
              <tr>
                <td class="newfont03">用工形式</td>
                <td class="newfont03"><select name="yyxs">
                    <option value="正式员工">正式员工</option>
                    <option value="临时员工">临时员工</option>
                </select></td>
                <td class="newfont03">人员来源</td>
                <td class="newfont03"><select name="ryly">
                    <option value="社会招聘">社会招聘</option>
                    <option value="校园招聘">校园招聘</option>
                    <option value="其他">其他</option>
                </select></td>
                <td class="newfont03">政治面貌</td>
                <td class="newfont03"><select name="zzmm">
                ...
                <td class="newfont03"><input name="birplace" type="text" size="6" /></td>
                <td class="newfont03">籍贯</td>
                <td><input name="native" type="text" value="抚顺" size="6" /></td>
                <td>户口</td>
                <td><input name="hkplace" type="text" value="抚顺" size="6" /></td>
              </tr>
              <tr>
                <td class="newfont03">联系电话</td>
                <td class="newfont03"><input name="tele" type="text" size="10" /></td>
                <td class="newfont03">电子邮件</td>
                <td class="newfont03"><input name="mail" type="text" size="10" /></td>
                <td>身高</td>
              ...
              <tr>
                ...
                <td colspan="3"><input name="graschool" type="text" size="10" /></td>
                <td>所学专业</td>
                <td><input name="professional" type="text" size="10" /></td>
                <td>毕业日期</td>
                <td><input name="gratime" type="text" onclick="setday(this)" size="12" /></td>
              </tr>
              <tr>
                <td>部门岗位安排</td>
                <td class="newfont03">部门名称<span class="STYLE4">*</span></td>
                <td class="newfont03"><label>
                  <input name="deptname" type="text" size="12" />
                </label></td>
                <td class="newfont03">部门编号<span class="STYLE4">*</span></td>
                <td class="newfont03"><input name="deptid" type="text" size="12" /></td>
                <td class="newfont03">岗位名称<span class="STYLE4">*</span></td>
                <td colspan="3"><input name="jobname" type="text" size="12" /></td>
                <td class="newfont03">岗位编号<span class="STYLE4">*</span></td>
                <td><input name="jobid" type="text" size="12" /></td>
                <td><span class="newfont03">员工状态<span class="STYLE4">*</span></span></td>
                <td><select name="yyct">
