...
<body>
<div id="man_zone">
  <form action="<%=basePath %>ChangeServlet?ff=changed" onsubmit="return link1();" method="post"  name="fom" id="fom" target="manFrame" >
    <div class="MainDiv">
                ...
                <td align="center"><br/>
                  ...
                  <!--   <tr>
                    ...
                    <!-- <tr>
                      ...
                      <td colspan="3"><label>
                      <div align="left">
                        <input name="r" type="radio" value="1" checked="checked" />
                        主动调动
                        <input type="radio" name="r" value="bdmove" />
                        被动调动
                        <input type="radio" name="r" value="upmove" />
                        升值
                        <input type="radio" name="r" value="downmove" />
                        降职 
                        <input type="radio" name="r" value="mistak" />
                        错误数据</div>
                      </label></td>
                    </tr> -->
                    <tr>
